...
std::string Server::buildWelcomeMessage(Channel &channel) 
{
    ...
    // if (membersList.length() > 15) {  // Verifica se há membros na lista (considera o comprimento da string "Channel Members: ")
    //     membersList.pop_back();  // Remove o espaço extra
    //     membersList.pop_back();  // Remove a vírgula extra
    // }
    membersList += "\n";
